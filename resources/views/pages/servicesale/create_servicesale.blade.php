            ...
            <div class="row" style="box-shadow: rgba(0, 0, 0, 0.45) 0px 25px 20px -20px;">
                <div class="col-md-12">
                    ...
                    <div class="container" style="background-color:#fff;">
                        <div class="row">
                            <div class="col-md-4">
                                <h2 style='color:#b90f72;font-weight:bold;margin-top:30px;'>Sales</h2>
                            ...
                            <div class="col-md-6" style="float:right;">
                                <h3 style='color:#b90f72;font-weight:bold;margin-top:30px;'>Sales TO</h3>
                                <table>
                                    ...
                                    <table class="invoice-item">
                                        <tr>
                                            ...
                                            <td style='border-right:none;'><button
                                                    style="float:right; border: 3px solid #eb329e; border-radius:40px;"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group row">
                                                <select id="cmbService" class="form-control form-control-round"
                                                    style='border-radius:40px;'>
...
$(function() {
    ...
    // $("#txtBookingId").on("keyup",function(){
    //     let booking_id = $(this).val();
        
        
    //     $.ajax({
    //         url: "{{url('get-customer-booking')}}",
    //         type: "get",
    //         data: {
    //             "id": booking_id 
    //         },
    ...
    //             if(res.booking!=null){
    //                 $("#txtName").html(res.booking.customer.name);
    //                 $("#txtMember_id").html(res.booking.customer.membership_id);
    //                 $("#txtMobile").html(res.booking.customer.mobile);
    //                 $("#txtAddress").html(res.booking.customer.address);
    //                 $("#advPaidAmount").val(res.booking.advance);
    //                 $("#cmbCustomer").val(res.booking.customer.id);
    //                 let sub=$("#subtotal").html();
    //                 let adv=$("#advPaidAmount").val();
    //                 let pay=sub-adv;
    //                 $("#paidAmount").val(pay);
    //             }else{
    //                 $("#txtName").html('');
    ...
    $("#cmbCustomer").on("change", function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#txtMember_id").html(customer.membership_id);
