                                ...
                                <form action="javascript:void(0)" >
                                        ...
                                        <div class="card-body">
                                            <table class="table table-bordered">
                                                ...
                                                <tr style="padding: 5px;">
                                                    ...
                                                    <td></td>
                                                    <td style="font-size: 15px; padding-left:10px;"><input class="check_id" name="menu_id" type="checkbox" value="{{$menu->id.':'.$menu->name}}">  {{$menu->name}}</td>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-2 offset-4">
                                            <input type="submit" name='btnCreate sourser:pointer' id="btnCreate" class="form-control"
                                               style="background-color: #E9118F; color:#fff; cursor: pointer;" value='Save'>
                                        </div>
                                    </div>
