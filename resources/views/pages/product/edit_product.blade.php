                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5><a href="{{url('products')}}">Manage Products</a></h5>
                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name='txtName'
                                                    class="form-control " value="{{$product->name}}" placeholder="category Name" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group row"> 
                                            <label class="col-sm-3 col-form-label">Product Category</label>
                                            <div class="col-sm-9">
                                                <select id="cmbCategory" name="cmbCategory" class="form-control" style='width:100%'>
                                        ...
                                        <div class="form-group row"> 
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name='price'
                                                    class="form-control" placeholder="0.00" value="{{$product->price}}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
