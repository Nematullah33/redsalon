            ...
            <div class="row" style="box-shadow: rgba(0, 0, 0, 0.45) 0px 25px 20px -20px;">
                <div class="col-md-12">
                    ...
                    <div class="container" style="background-color:#fff;">
                        <div class="row">
                            <div class="col-md-4">
                                <h2 style='color:rgb(183 23 23);font-weight:bold;margin-top:30px;'>INVOICE</h2>
                                <table>
                                    <tr>
                                        <td>Invoice No</td>
                                        <td>:</td>
                            ...
                            <div class="col-md-12">
                                ...
                                {{$dis_total=0}}">
                                    ...
                                    <tr>
                                        ...
                                        <td style='text-align:right; padding-right:68px;'>{{$detail->price*$detail->qty-$detail->discount}}</td>
