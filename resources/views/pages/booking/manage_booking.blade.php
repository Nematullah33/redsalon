        ...
        <div class="page-wrapper">
            <div class="card">
                <div class="card-header">
                            ...
                            <a class="float-right pr-5" href="{{route('bookings.index')}}">
                                <h6> Refresh</h6>
                            </a>
                    ...
                    <div class="row" style='margin:-10px; padding:0px;'>
                        <div class="col-md-12">
                                ...
                                <div class="form-group row border-primary" style="background-color: aliceblue">
                                    ...
                                    <div class="col-sm-4 p-2">
                                        <input style="padding: 0.2rem 0.75rem;" type="text" id='booking_date' value="" name='booking_date'
                                                class="form-control" placeholder="Booking Date" autocomplete="off">
                                    </div>
                                    <div class="col-sm-2 p-2">
                                        <input type='button' style="padding: 0.35rem 2.375rem;" id='selectDate' value="Apply" class="btn btn-sm btn-info">
                                    </div>
                                ...
                                <div class="">
                                    <div class="row p-3" style="border-radius: 5px;">
                                        <div style="background-color:#e9118f; color:#fff" class="p-3">
                                            <h4>{{date('d-M-y', strtotime($booking->booking_date))}}</h4>
                                        ...
                                        <div style="background-color:#f53ca8;color:#fff;max-width:176px;" class="p-3">
                                            ...
                                            @foreach($booking->bookingdetail as $details_data)
                                                <span style='padding-left:5px;'>{{$details_data->service->name}}</span>    
                                            @endforeach
                                        </div>
...
<script>
   ...
   $(function(){
                        ...
                        html+="<div>";
                            html+="<div class='row p-3' style='border-radius: 5px;''>";
                                html+="<div style='background-color:#e9118f; color:#fff;' class='p-3'>";
                                    html+="<h4>"+booking.booking_date+"</h4>";
                                    html+="<p style='border:1px solid #ccc; text-align:center;border-radius:3px; padding:0px;'>"+booking.booking_time+"</p>";
                                    ...
                                    html+="<div style='background-color:#f53ca8; color:#fff;' class='p-3'>";
                                        ...
                                        html+=" <p style='padding-left:5px;'><span class='ti-email'></span>  "+booking.customer.email+"</p>";
                                            for(details_data of booking.bookingdetail){
                                                html+="<span style='padding-left:5px;'>"+details_data.service.name+"</span>";    
                                            }
                                            html+="</div>";
        ...
        $("#selectDate").on("click",function(e){ 
           e.preventDefault;    
           $.ajax({
             url:"<?php echo url("get/boooking/date")?>",
             type:'GET',
             data:{"date":$("#booking_date").val()},
             success:function(res){
               let html="";
                for(booking of res){
                    html+="<div class='col-md-12' style='width:100%'>";
